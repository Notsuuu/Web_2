            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="student_id_number" name="student_id_number"
                           ...
                           placeholder="Student ID (e.g. D021, PSI2021)"
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="major_id" id="major_id"
                            class="px-3 py-2 border border-zinc-300 appearance-none bg-slate-50">
                        <option disabled selected>Select Majors</option>
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="status" id="status"
                            class="px-3 py-2 border border-zinc-300 appearance-none bg-slate-50">
                        <option value="" disabled {{ old('status', $student->status) == '' ? 'selected' : '' }}>Select Status</option>
