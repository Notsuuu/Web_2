...
<main>
    <header x-data="{ open: false }" class="flex items-center justify-between sm:justify-start gap-8 bg-white border-b border-b-zinc-100 sticky top-0 px-3 sm:px-10 py-4">
        <h1 class="text-xl sm:text-2xl font-bold">Student Management</h1>
        ...
        <button @click="open = !open" class="block sm:hidden bg-slate-50 border border-slate-400 p-2">
            <i class="ph-list block text-slate-400"></i>
        </button>
